...
class AddExperience extends Component {
  ...
  render() {
    const {
      isLoading, fontLoaded, company, title, location, from, to, discription, errors } = this.state;
    return !fontLoaded ? (
      <Text> Loading... </Text>
    ) : (
      <ScrollView
      ...
      >
        ...
        >
          <Text style={styles.signUpText}>Add Experience</Text>
         
          
          
          <View style={{ width: '80%', alignItems: 'center' }}>
            <FormInput
              refInput={input => (this.companyInput = input)}
              icon="building"
              value={company}
